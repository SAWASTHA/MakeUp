              ...
              <div>
                ...
                <form>
                  ...
                  <div className="d-flex justify-content-center">
                    <button
                      type="submit"
                      className="btn btn-dark my-2 custom-button"
                    >
                      Send Message
                    </button>
                  </div>
                ...
                <div className="col-12">
                  <div className="d-flex align-items-center mt-3">
                    ...
                    <p className="mb-0 add text-black">
                      Preet Makeover, Sangram Nagar, Aurangabad,
                      Maharashtra-431005
                    </p>
                  </div>
                  <div className="d-flex align-items-center mt-3">
                  ...
                  <div className="d-flex align-items-center mt-3">
                    <a
                      ...
                      className="me-3 icon text-black"
                    >
                      <FaInstagram />
                    </a>
                    <a href="https://wa.me" className="me-3 icon text-black">
                      <FaWhatsapp />
                    </a>
                    <a
