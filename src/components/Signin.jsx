        ...
        <Tabs defaultValue="signin" className="w-full">
          ...
          <TabsContent value="signin">
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <Input className="text-black" id="password" type={showPassword ? "text" : "password"} />
                    <button
                      type="button"
                      className={`absolute inset-y-0 right-0 px-2 flex items-center ${isDarkMode ? 'text-white' : 'text-black'}`}
              ...
              <CardFooter>
                <Button className={`mt-3 w-full ${isDarkMode ? 'bg-gray-800 text-white hover:text-black' : 'bg-gray-200 text-black hover:text-black'}`}>Signin</Button>
              </CardFooter>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <Input className="text-black" id="current" type={showPassword ? "text" : "password"} />
                    <button
                      type="button"
                      className={`absolute inset-y-0 right-0 px-2 flex items-center ${isDarkMode ? 'text-white' : 'text-black'}`}
                      onClick={togglePasswordVisibility}
                ...
                <div className="space-y-1">
                  <Label className="text-black" htmlFor="new">Confirm Password</Label>
                  <div className="relative">
                    <Input className="text-black" id="new" type={showConfirmPassword ? "text" : "password"} />
                    <button
                      type="button"
                      className={`absolute inset-y-0 right-0 px-2 flex items-center ${isDarkMode ? 'text-white' : 'text-black'}`}
              ...
              <CardFooter>
                <Button className={`mt-3 w-full ${isDarkMode ? 'bg-gray-800 text-white hover:text-black' : 'bg-gray-200 text-black hover:text-black'}`}>Signup</Button>
              </CardFooter>
            </Card>
          </TabsContent>
        </Tabs>
