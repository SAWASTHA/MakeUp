  ...
  return (
    <div style={{ overflow: "hidden"  }}>
      <div className="row mx-2">
        ...
        <motion.div className="col-lg-4 mb-4 mb-lg-0" style={{ y: colTwoTranslate }}>
        ...
        <motion.div className="col-lg-4 mb-4 mb-lg-0" style={{ y: colThreeTranslate }}>
          <div className="flex flex-col space-y-3 mb-2">
            {!imagesLoaded && (
              <Skeleton className="h-[355px] w-[250px] w-100 shadow-1-strong rounded mb-4" />
            )}
      ...
      Take a look at my work
        ...
        <motion.div className="col-lg-4 mb-2" style={{ y: colTwoTranslate }}>
          <img
        ...
        <motion.div className="col-lg-4 mb-2" style={{ y: colThreeTranslate }}>
          <img
