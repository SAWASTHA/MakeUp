       ...
       <div className="row mx-2 my-2">
        <div className="col-lg-4 col-md-12 mb-4 mb-lg-0">
          ...
          <div className="flex flex-col space-y-3 mb-2">
            {!imagesLoaded && <Skeleton className="h-[355px] w-[250px] w-100 shadow-1-strong rounded mb-4" />}
          </div>
        ...
        <div className="col-lg-4 mb-4 mb-lg-0">
          <div className="flex flex-col space-y-3 mb-2">
            {!imagesLoaded && <Skeleton className="h-[400px] w-[250px] w-100 shadow-1-strong rounded mb-4" />}
          </div>

          <div className="flex flex-col space-y-3 ">
            {!imagesLoaded && <Skeleton className="h-[310px] w-[250px] w-100 shadow-1-strong rounded mb-4" />}
          </div>
        </div>
