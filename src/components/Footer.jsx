...
export default function Footer() {
    ...
    return (
        <footer className={`bg-gray-900 text-gray-200 py-12 px-4 md:px-6 lg:px-8 ${bgColor}`}>
            <Container>
                ...
                <Row className="justify-content-between">
                    ...
                    <Col md={4} className={`${textColor}`}>
                        ...
                        <p className="mb-4">Subscribe to our newsletter for exclusive offers and the latest beauty news.</p>
                        <form className="flex flex-col sm:flex-row">
                            <input
                                ...
                                type="email"
                            />
                            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 mx-2 mb-2 rounded" type="submit">
                                Subscribe
                            </button>
                        </form>
